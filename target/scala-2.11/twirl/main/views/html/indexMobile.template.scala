...
class indexMobile extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {
...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="imagesM/favicon.png">
    ...
    <style>
    #view-source """),format.raw/*36.18*/("""{"""),format.raw/*36.19*/("""
      """),format.raw/*37.7*/("""position: fixed;
      display: block;
      right: 0;
      bottom: 0;
      margin-right: 40px;
...
object indexMobile extends indexMobile_Scope0.indexMobile
              /*
                  -- GENERATED --
                  DATE: Sun Apr 30 18:41:21 COT 2017
